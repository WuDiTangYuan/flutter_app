...
import 'package:flutter_app/pages/chat/search_bar.dart';
import 'package:flutter_app/tools/http_manager.dart' as http;
...
//    _cancleConnect = false;
    final response = await http.get(
        'http://rap2.taobao.org:38080/app/mock/256798/api/chat/list',
        timeout: 100);
